...
RAW_FILE_NAMES_UMPM = {'train': 'D:/Downloads/T2P/T2P-main/data/Mocap_UMPM/train_3_75_mocap_umpm.npy', 'val': 'D:/Downloads/T2P/T2P-main/data/Mocap_UMPM/test_3_75_mocap_umpm.npy', 'test': 'D:/Downloads/T2P/T2P-main/data/Mocap_UMPM/test_3_75_mocap_umpm.npy'}
...
if __name__ == '__main__':
    ...
    A1D = mocap_UMPM('train', process_dir='D:/Downloads/T2P/T2P-main/preprocessed/mocap_UMPM_input25_v2', root='data/Mocap_UMPM',
                             process=True, spec_args=spec_args)
    A1D = mocap_UMPM('val', process_dir='D:/Downloads/T2P/T2P-main/preprocessed/mocap_UMPM_input25_v2',
                     root='data/Mocap_UMPM',
                     process=True, spec_args=spec_args)
    A1D = mocap_UMPM('test', process_dir='D:/Downloads/T2P/T2P-main/preprocessed/mocap_UMPM_input25_v2',
                     root='data/Mocap_UMPM',
                     process=True, spec_args=spec_args)
