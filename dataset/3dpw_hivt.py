...
RAW_FILE_NAMES_3DPW = {'train': 'D:/Downloads/T2P/T2P-main/data/poseData.pkl', 'val': 'D:/Downloads/T2P/T2P-main/data/poseData.pkl', 'test': 'D:/Downloads/T2P/T2P-main/data/poseData.pkl'}
def Rx(theta):
...
if __name__ == '__main__':
    ...
    A1D = _3DPW('train', process_dir='D:/Downloads/T2P/T2P-main/preprocessed/3dpw_input10_v2', root='data/',
                process=True, spec_args=spec_args)
    A1D = _3DPW('val', process_dir='D:/Downloads/T2P/T2P-main/preprocessed/3dpw_input10_v2', root='data/',
                             process=True, spec_args=spec_args)
    A1D = _3DPW('test', process_dir='D:/Downloads/T2P/T2P-main/preprocessed/3dpw_input10_v2', root='data/',
                process=True, spec_args=spec_args)
